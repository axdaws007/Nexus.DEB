...
namespace Nexus.DEB.Application.Common.Interfaces
{
    public interface IDebService
    {
		...
		Task<Scope?> UpdateScopeRequirementsAsync(Guid scopeId, StandardVersion standardVersion, List<Guid> idsToAdd, List<Guid> idsToRemove, bool addAll, bool removeAll, CancellationToken cancellationToken);
