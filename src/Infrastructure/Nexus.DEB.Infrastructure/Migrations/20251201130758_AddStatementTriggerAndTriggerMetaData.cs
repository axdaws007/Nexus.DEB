...
{
    /// <inheritdoc />
    public partial class AddStatementTriggerAndTriggerMetaData : Migration
    {
		/// <inheritdoc />
...
/****** Object:  Trigger [Statement_ChangeTracking]    Script Date: 27/11/2025 15:45:09 ******/
DROP TRIGGER IF EXISTS [deb].[Statement_ChangeTracking]
GO

/****** Object:  Trigger [common].[Statement_ChangeTracking]    Script Date: 27/11/2025 15:45:09 ******/
SET ANSI_NULLS ON
GO
...
");
			...
			EXEC sys.sp_addextendedproperty 
				...
				@level1type = N'TABLE',  @level1name = N'Statement',
				@level2type = N'COLUMN', @level2name = N'ReviewDate';");
			#endregion
		}
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.Sql(@"
				ALTER TABLE [deb].[Statement] DISABLE TRIGGER [Statement_ChangeTracking]
				DROP TRIGGER IF EXISTS [deb].[Statement_ChangeTracking]
            ");
		}
	}
