...
{
    /// <inheritdoc />
    public partial class UpdateTriggersWithSP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
			#region New Stored Procedure
			migrationBuilder.Sql(@"
				
/****** Object:  StoredProcedure [dbo].[CreateChangeRecordWithinTrigger]    Script Date: 03/12/2025 12:22:06 ******/
DROP PROCEDURE IF EXISTS [dbo].[CreateChangeRecordWithinTrigger]
GO
...
*/
CREATE PROCEDURE [dbo].[CreateChangeRecordWithinTrigger]
	@PKValueSelect VARCHAR(128),
	@PKCols VARCHAR(128),
	@Comments NVARCHAR(MAX),
	@UserName NVARCHAR(128),
	@ChangeEventId UNIQUEIDENTIFIER,
	@ChangeRecordId int OUTPUT
AS
BEGIN
	...
	SELECT @sql = @sql + ' FROM #ins i FULL OUTER JOIN #del d' -- T
...
/****** Object:  Trigger [StatementRequirementScope_ChangeTracking]    Script Date: 03/12/2025 09:51:35 ******/
DROP TRIGGER [deb].[StatementRequirementScope_ChangeTracking]
GO

/****** Object:  Trigger [deb].[StatementRequirementScope_ChangeTracking]    Script Date: 03/12/2025 09:51:36 ******/
SET ANSI_NULLS ON
GO
...
GO
			...
			#region Statement_ChangeTracking Trigger
			migrationBuilder.Sql(@"
/****** Object:  Trigger [Statement_ChangeTracking]    Script Date: 03/12/2025 09:09:28 ******/
DROP TRIGGER [deb].[Statement_ChangeTracking]
GO

/****** Object:  Trigger [deb].[Statement_ChangeTracking]    Script Date: 03/12/2025 09:09:28 ******/
SET ANSI_NULLS ON
GO
...
GO
			...
			#region New Stored Procedure
			migrationBuilder.Sql(@"DROP PROCEDURE IF EXISTS [dbo].[CreateChangeRecordWithinTrigger]");
			#endregion
		}
	}
}
