...
{
    /// <inheritdoc />
    public partial class UpdateCreateChangeRecordItemSP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
/****** Object:  StoredProcedure [dbo].[CreateChangeRecordItem]    Script Date: 29/01/2026 14:42:24 ******/
...
BEGIN
	...
	DECLARE @ChangeRecordId INT,
			@Username NVARCHAR(128)

	IF @ChangeEventId IS NULL -- First we look for a provided ChangeEventId
	BEGIN
		SELECT @ChangeEventId = TRY_CONVERT(uniqueidentifier, SESSION_CONTEXT(N'EventId')) -- If ChangeEventId not explicitly provided, look in Session Context.
