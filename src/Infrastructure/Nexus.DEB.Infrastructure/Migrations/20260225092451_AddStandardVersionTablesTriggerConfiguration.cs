...
{
    /// <inheritdoc />
    public partial class AddStandardVersionTablesTriggerConfiguration : Migration
    {
        /// <inheritdoc />
...
-- Description:	Change Tracking for the Many to Many StandardVersionRequirement table
-- =============================================
...
END
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"DROP TRIGGER [deb].[StandardVersion_ChangeTracking]");
        }
    }
}
