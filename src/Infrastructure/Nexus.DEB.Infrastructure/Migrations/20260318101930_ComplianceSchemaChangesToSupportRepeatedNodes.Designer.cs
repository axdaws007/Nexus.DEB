...
namespace Nexus.DEB.Infrastructure.Migrations
{
    ...
    [Migration("20260318101930_ComplianceSchemaChangesToSupportRepeatedNodes")]
    partial class ComplianceSchemaChangesToSupportRepeatedNodes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nexus.DEB.Domain.Models.ComplianceTreeNode", b =>
                {
                    ...
                    b.HasIndex("StandardVersionID", "ScopeID")
                        .HasDatabaseName("IX_ComplianceTreeNode_Tree");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("StandardVersionID", "ScopeID"), new[] { "NodeType", "EntityID", "ParentNodeType", "ParentEntityID", "ComplianceStateID", "ComplianceStateLabel" });

                    b.HasIndex("StandardVersionID", "ScopeID", "NodeType", "EntityID")
                        .IsUnique()
                    ...
                    b.HasIndex("StandardVersionID", "ScopeID", "NodeType", "EntityID", "ParentComplianceTreeNodeID")
                        .IsUnique()
