    ...
    public static class TestDataEndpoints
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var statementFaker = new Faker<Statement>()
                ...
                .RuleFor(s => s.ReviewDate, f => DateOnly.FromDateTime(f.Date.Future(1)))
            ...
            var taskFaker = new Faker<Domain.Models.Task>()
                ...
                .RuleFor(t => t.DueDate, f => DateOnly.FromDateTime(f.Date.Between(DateTime.UtcNow.AddDays(7), DateTime.UtcNow.AddDays(90))))
